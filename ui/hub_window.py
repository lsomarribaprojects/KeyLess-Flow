...
class EditTranscriptDialog(QDialog):
    ...
    def __init__(self, row_id: int, original_text: str):
        ...
        lbl = QLabel("Corrige el texto. KeyLess by Sinsajo sugiere automáticamente palabras nuevas (nombres, jerga) para el diccionario.")
...
class SnippetsPage(QWidget):
    def __init__(self):
        ...
        sub = QLabel(
            'Atajos de voz. Cuando dictes el trigger, KeyLess by Sinsajo lo reemplaza por la expansión. '
...
class SettingsPage(QWidget):
    def __init__(self):
        ...
        relaunch_btn = QPushButton("Reiniciar KeyLess by Sinsajo")
    ...
    def _relaunch(self):
        confirm = QMessageBox.question(
            self, "Reiniciar KeyLess by Sinsajo",
    ...
    def _save(self):
        ...
        if needs_restart:
            ...
            box.setText("Algunos cambios requieren reiniciar KeyLess by Sinsajo para aplicarse.")
...
class HubWindow(QWidget):
    def __init__(self, db: TranscriptionDB):
        super().__init__()
        self.db = db
        self.setWindowTitle("KeyLess by Sinsajo")
        self.resize(880, 620)
        self.setStyleSheet(f"background: {C.BG}; color: {C.TEXT};")
        ...
        name = QLabel("KeyLess by Sinsajo")
